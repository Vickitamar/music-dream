...
function createPlaylist() {
	var alert2 = prompt("Please enter the name of your playlist");

	if(alert2 != null) {
		$.post("includes/handlers/ajax/createPlaylist.php", { name: alert2, username: userLoggedIn }).done(function(error) {
...
function formatTime(seconds) {
	...
	var extraZero = (seconds < 10) ? "0" : ""; //lovely conditional statement
